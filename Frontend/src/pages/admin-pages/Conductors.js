...
const ManageConductors = () => {
  ...
  const fetchConductors = async () => {
    ...
    try {
      ...
      toast.error(err.response?.data?.message || "Failed to fetch conductors");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleDelete = async (id) => {
    try {
      ...
      toast.error(err.response?.data?.message || "Failed to delete conductor");
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
            <div className="p-4 border-b border-gray-200 flex justify-between items-center bg-gray-50">
              <h2 className="font-semibold text-gray-800">
                {editingId ? "Edit Conductor" : "Add New Conductor"}
              </h2>
              <button
                onClick={() => {
                  resetForm();
            ...
            >
              ...
              {/* Password only when adding or optional in update */}
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
          <div className="p-4 border-b border-gray-200 bg-gray-50">
            <h2 className="font-semibold text-gray-800">All Conductors</h2>
          </div>
